...
- (void)awakeFromNib{
    ...
    switch (self.tag) {
        case 100:
        {
            [self setJYHomeNewsSettings];
        }
            break;
        case 200:
        {
            [self setJYHomeMarketSettings];
        }
            break;
        case 300:
        {
            [self setJYStraightPinSettings];
        }
            break;
...
- (void)setInitialSettings{
    ...
    _currentScrollLabel.adjustsFontSizeToFitWidth = YES;
    _standbyScrollLabel.adjustsFontSizeToFitWidth = YES;
